...
namespace INFOIBV
{
    ...
    /// </summary>
    /// <typeparam name="T">The type of elements in the DMaxHeap&lt;T>.</typeparam>
        ...
        where T : IComparable<T>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the DMaxHeap&lt;T> that contains the elements copied from the specified IEnumerable&lt;T>.
        /// </summary>
        /// <param name="collection">The IEnumerable&lt;T> whose elements are copied to the new DMaxHeap&lt;T>.</param>
        /// <param name="d">The order of the DMaxHeap&lt;T>.</param>
    ...
    /// </summary>
    /// <typeparam name="T">The type of elements in the DMinHeap&lt;T>.</typeparam>
        ...
        where T : IComparable<T>
    {
        ...
        /// <summary>
        /// Initialises a new instance of the DMinHeap&lt;T> that contains the elements copied from the specified IEnumerable&lt;T>.
        /// </summary>
        /// <param name="collection">The IEnumerable&lt;T> whose elements are copied to the new DMinHeap&lt;T>.</param>
        /// <param name="d">The order of the DMinHeap&lt;T>.</param>
    ...
    /// </summary>
    /// <typeparam name="T">The type of elements in the DHeap&lt;T>.</typeparam>
